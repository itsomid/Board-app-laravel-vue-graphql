            ...
            <div class="w-full sm:shadow-xl sm:bg-white sm:py-8 sm:px-10"><!---->
                ...
                <form>
                    ...
                    <div class="w-full mb-6">
                        <button type="submit" class="rounded-md px-4 py-2 text-sm bg-green-500 font-bold outline-none focus:outline-none hover:opacity-75 w-full text-white disabled:opacity-25">
                            Login
                        </button>
                    </div>
                </form>
                ...
                <div class="text-center text-sm">
                    <a href="/register" class="text-blue-600 hover:underline">Sign up for an account</a>
                </div>
            </div>
        </div>
    </div>
